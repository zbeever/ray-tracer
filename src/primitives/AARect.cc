...
std::shared_ptr<AARect> AARect::make(char _axis, double _b0, double _b1, double _c0, double _c1, double _k, std::shared_ptr<Material> mat)
{
	return std::make_shared<AARect>(_axis, _b0, _b1, _c0, _c1, _k, mat);
}
