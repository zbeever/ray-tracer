...
public:
	Camera(int pixel_width_v, int pixel_height_v, float vertical_fov_v, float aperture_v = 1.0f): pixel_width(pixel_width_v), pixel_height(pixel_height_v), vertical_fov(vertical_fov_v), aperture(aperture_v)
	{
